...
function gulpIndexer(options) {
  ...
  var stream = through.obj(function(file, enc, done) {
    ...
    $links.each(function(index, link){
      ...
      var endOfRange = $link.attr("data-startref");
      var seeAlos = $link.attr("see-also");
      var see = $link.attr("see");
      var letter = $link.attr("letter");
      ...
      if(endOfRange) {
        return; // Not using ranges for now
      }
      ...
      if(letter) {
        item.charecter = letter.toUpperCase();
