...
function gulpReplaceIDs(options) {
  ...
  settings = _.defaults(options || {}, {
    ...
    output: true,
    elements: this.prototype.ELEMENTS
  });
  ...
  var stream = through.obj(function(file, enc, done) {
    ...
    $elements.each(function(index, element){
      var $element = $(element);
      var generatedId = generateID($element, filePath);
...
gulpReplaceIDs.prototype.ELEMENTS = "chapter:not([id]), section:not([id]), a[data-type='indexterm']:not([id]), div[data-type]:not([id]), aside:not([id]), figure:not([id])";
