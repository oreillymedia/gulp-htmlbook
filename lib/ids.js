...
function gulpReplaceIDs(options) {
  ...
  var settings = _.defaults(options || {}, {
    ...
    output: true,
    elements: gulpReplaceIDs.ELEMENTS
  });
...
gulpReplaceIDs.ELEMENTS = "chapter:not([id]), section:not([id]), a[data-type='indexterm']:not([id]), div[data-type]:not([id]), aside:not([id]), figure:not([id])";
